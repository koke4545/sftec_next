...
const TermsCondition = async({ params, searchParams }: any) => {

  const dataService = createDataService();
  const headersList = headers();    

  const dataModel: { [key: string]: any } = appHelper.initializePageDataModel('TermsCondition', params, searchParams, headersList);
  ...
  metadata.description = `Terms & Conditions`;
  /*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `Terms & Conditions`;
