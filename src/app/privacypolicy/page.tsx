...
const PrivacyPolicy = async({ params, searchParams }: any) => {

  const dataService = createDataService();
  const headersList = headers();    

  const dataModel: { [key: string]: any } = appHelper.initializePageDataModel('PrivacyPolicty', params, searchParams, headersList);
  ...
  metadata.title = `Privacy & Security Policy Update`;
  /*** End of metadata.title ***/

  /*** Start of metadata.description ***/
  metadata.description = `Privacy & Security Policy Update`;
  /*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `Privacy & Security Policy Update`;
