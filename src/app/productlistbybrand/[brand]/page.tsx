...
const productListbybrand = async({ params, searchParams }: any) => {
  ...
  {
    const apiResult_Sft_ProductSearch = await dataService.callMgtGetApiByCode('Sft_ProductSearch', { 'Catalog1': '', 'Catalog2': '', 'Catalog3': '', 'ProductType': '', 'DistributorId': dataModel.searchParams.distributorid_id, 'ProductName': '', 'Brand': dataModel.params.brand_id, 'Department': '', 'Type': '',  }, {isUseCache: true});
...
/*** End of metadata.title ***/
  ...
  metadata.description = `SFTec Products, ${dataModel.params.brand_display}`;
/*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `SFTec Products, ${dataModel.params.brand_display}`;
