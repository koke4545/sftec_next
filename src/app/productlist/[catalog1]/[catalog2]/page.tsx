...
const productlist = async({ params, searchParams }: any) => {
  ...
  {
    const apiResult_Sft_ProductSearch = await dataService.callMgtGetApiByCode('Sft_ProductSearch', { 'Catalog1': dataModel.params.catalog1_id, 'Catalog2': dataModel.params.catalog2_id, 'Catalog3': '', 'ProductType': '', 'DistributorId': dataModel.searchParams.distributorid_id, 'ProductName': '', 'Brand': '', 'Department': '', 'Type': '',  }, {isUseCache: true});
...
/*** End of metadata.title ***/
  ...
  metadata.description = `SFTec Products, ${dataModel.params.catalog1_display}, ${dataModel.params.catalog2_display}`;
/*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `SFTec Products, ${dataModel.params.catalog1_display}, ${dataModel.params.catalog2_display}`;
