...
const ShippingDelivery = async({ params, searchParams }: any) => {

  const dataService = createDataService();
  const headersList = headers();    

  const dataModel: { [key: string]: any } = appHelper.initializePageDataModel('ShippingDelivery', params, searchParams, headersList);
  ...
  metadata.title = `Shipping & Delivery`;
  /*** End of metadata.title ***/

  /*** Start of metadata.description ***/
  metadata.description = `Shipping & Delivery`;
  /*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `Shipping & Delivery`;
