...
const productsearchbyname = async({ params, searchParams }: any) => {
  ...
  {
    const apiResult_Sft_ProductSearch = await dataService.callMgtGetApiByCode('Sft_ProductSearch', { 'Catalog1': '', 'Catalog2': '', 'Catalog3': '', 'ProductType': '', 'DistributorId': dataModel.searchParams.distributorid_id || '', 'ProductName': dataModel.params.productname_id, 'Brand': '', 'Department': '', 'Type': '',  }, {isUseCache: true});
  ...
  metadata.title = `SFTec Products Search: ${dataModel.params.productname_id}`;
/*** End of metadata.title ***/

  /*** Start of metadata.description ***/
  metadata.description = `SFTec Products Search: ${dataModel.params.productname_id}`;
/*** End of metadata.description ***/

  /*** Start of metadata.keywords ***/
  metadata.keywords = `SFTec Products Search: ${dataModel.params.productname_id}`;
